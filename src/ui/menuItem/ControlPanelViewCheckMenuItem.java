 ...
 *
 */
public class ControlPanelViewCheckMenuItem extends UiMenuItemAbstract {

    private static String myKey = "MenuItemControlPanel";

    private CheckMenuItem myCheckMenuItem; 
    public ControlPanelViewCheckMenuItem(ResourceBundle resourceBundle, PageViewer pageViewer) {
	...
	myCheckMenuItem.selectedProperty().addListener(new ChangeListener<Boolean>() {
		...
		pageViewer.getCurrentActiveWorkspace().setControlPanelVisible(new_val);
	    }
	});
    }
}
